...
FREENECTAPI_SYNC void freenect_sync_map_rgb_to_depth(uint16_t* depth_mm, uint8_t* rgb_raw, uint8_t* rgb_registered, int index);


FREENECTAPI_SYNC void freenect_sync_isolate_object(uint16_t* depth_mm, uint8_t* rgb_raw, uint32_t* borders, uint8_t* rgb_registered, int index);
